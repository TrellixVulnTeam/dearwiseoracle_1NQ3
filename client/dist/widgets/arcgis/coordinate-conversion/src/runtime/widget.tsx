...
export default class Widget extends BaseWidget<AllWidgetProps<IMConfig>, State> {
  ...
  constructor (props) {
    ...
    let geometryServiceURL = 'https://utility.arcgisonline.com/arcgis/rest/services/Geometry/GeometryServer'
    if (this.props.portalSelf && this.props.portalSelf.helperServices && this.props.portalSelf.helperServices.geometry &&
      this.props.portalSelf.helperServices.geometry.url) { // Use org's geometry service if available
      geometryServiceURL = this.props.portalSelf.helperServices.geometry.url
    }
