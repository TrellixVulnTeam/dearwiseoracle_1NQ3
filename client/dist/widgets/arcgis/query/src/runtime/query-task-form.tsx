...
export function QueryTaskForm (props: QueryTaskItemProps) {
  const { widgetId, configId, outputDS, spatialFilterEnabled, onFormSubmit } = props
    ...
    <QueryTaskContext.Provider value={{ resetSymbol }}>
      <div className='query-form' css={getFormStyle(isAutoHeight)}>
        <div className='query-form__content my-2'>
          {showAttributeFilter && (
            <div role='group' aria-label={attributeFilterLabel}>
        ...
        <div className='query-form__actions d-flex align-items-center'>
          <Button className='active ml-auto' onClick={applyQuery}>
