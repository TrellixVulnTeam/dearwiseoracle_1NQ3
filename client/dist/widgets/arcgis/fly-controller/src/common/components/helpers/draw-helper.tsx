...
import { JimuDraw, JimuDrawCreationMode, DrawingElevationMode3D, DrawToolClass } from 'jimu-ui/advanced/map'
...
export default class DrawHelper extends React.PureComponent<Props, States> {
    ...
    return this.state.apiLoaded && this.props.jimuMapView &&
      ...
      <div style={{ display: 'none' }}>
        <JimuDraw
          ...
          onDrawCreated={this.handleDrawToolCreated}
          onDrawActived={this.handleDrawToolsActived}
          onDrawStart={this.handleDrawStart}
          onDrawEnd={this.handleDrawEnd}
          onDrawCancel={this.handleDrawCancel}
          onGraphicsEdited={this.handleDrawFinish}
          // visibleElements
  ...
  // return jsObjects
  handleDrawFinish = ({ type, graphics, layer }: { type: ('complete' | 'deleted' | 'modified' | 'aborted'), graphics: __esri.Graphic[], layer: __esri.GraphicsLayer }): void => {
