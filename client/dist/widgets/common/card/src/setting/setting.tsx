...
> {
  ...
  getTemplateSize = () => {
    ...
    const templateSize = {
      STYLE0: { width: (cardWidth1 * 100) / viewportWidth, height: (340 * 100) / viewportHeight },
      STYLE1: { width: (cardWidth1 * 100) / viewportWidth, height: (405 * 100) / viewportHeight },
      STYLE2: { width: (cardWidth1 * 100) / viewportWidth, height: (391 * 100) / viewportHeight },
      STYLE3: { width: (cardWidth1 * 100) / viewportWidth, height: (344 * 100) / viewportHeight },
      STYLE4: { width: (cardWidth1 * 100) / viewportWidth, height: (368 * 100) / viewportHeight },
      STYLE5: { width: (cardWidth1 * 100) / viewportWidth, height: (407 * 100) / viewportHeight },
      STYLE6: { width: (cardWidth1 * 100) / viewportWidth, height: (300 * 100) / viewportHeight },
      STYLE7: { width: (cardWidth1 * 100) / viewportWidth, height: (300 * 100) / viewportHeight },
      STYLE8: { width: (cardWidth2 * 100) / viewportWidth, height: (200 * 100) / viewportHeight },
      STYLE9: { width: (cardWidth2 * 100) / viewportWidth, height: (200 * 100) / viewportHeight },
      STYLE10: { width: cardWidth1 / viewportWidth, height: (391 * 100) / viewportHeight }
    }
    return templateSize
  }
