...
describe('<SettingAdvanced />', () => {
  ...
  describe('given themeBoxDataItems prop', () => {
    ...
    it('ThemeColorPicker has value prop properly provided', () => {
      ...
      expect(ThemeColorPickers[0]).toHaveAttribute('data-color', themeBoxStyle.default.color)
      expect(ThemeColorPickers[1]).toHaveAttribute('data-color', themeBoxStyle.default.bg)
    })
  })
})
