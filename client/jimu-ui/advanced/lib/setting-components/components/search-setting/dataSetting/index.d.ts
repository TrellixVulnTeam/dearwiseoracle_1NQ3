...
interface SearchDataSettingProps {
    ...
    */
    portalUrl?: string;
    /**
     * Whether it is a newly created widget
    */
    isNewWidget?: boolean;
    /**
    ...
    */
     ...
     * @event
    */
    createOutputDs?: (dataSourceJson: DataSourceJson[], datasourceConfig: ImmutableArray<SearchDataConfig>) => void;
}
