 ...
 */
export declare const MapWidgetSelector: ReactRedux.ConnectedComponent<React.FC<import("react-intl").WithIntlProps<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, keyof MapWidgetSelectorProps | "mapWidgetJsons" | "intl"> & {
    theme?: import("jimu-core").IMThemeVariables;
}>> & {
    WrappedComponent: React.ComponentType<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, keyof MapWidgetSelectorProps | "mapWidgetJsons" | "intl"> & {
        theme?: import("jimu-core").IMThemeVariables;
    }>;
}, ReactRedux.Omit<import("react-intl").WithIntlProps<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, keyof MapWidgetSelectorProps | "mapWidgetJsons" | "intl"> & {
    theme?: import("jimu-core").IMThemeVariables;
 ...
 */
export declare const JimuMapViewSelector: ReactRedux.ConnectedComponent<React.FC<import("react-intl").WithIntlProps<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, keyof MapWidgetSelectorProps | "mapWidgetJsons" | "intl"> & {
    theme?: import("jimu-core").IMThemeVariables;
}>> & {
    WrappedComponent: React.ComponentType<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, keyof MapWidgetSelectorProps | "mapWidgetJsons" | "intl"> & {
        theme?: import("jimu-core").IMThemeVariables;
