...
declare const _default: ReactRedux.ConnectedComponent<React.ForwardRefExoticComponent<Pick<any, string | number | symbol> & {
    ...
    theme?: IMThemeVariables;
}, "footer" | "header" | "browserSizeMode" | "dispatch" | "mainSizeMode" | "pages" | "isPrintPreview" | "headerVisible" | "footerVisible" | "splashDialogJson" | "isSplashClosed" | "pageDialogId" | "pageDialogJson" | "isPageDlgClosed" | "urlDialogJson"> & PageProps>;
