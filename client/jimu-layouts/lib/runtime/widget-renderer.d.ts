...
export declare const WidgetRenderer: ReactRedux.ConnectedComponent<typeof _WidgetRenderer, ReactRedux.Omit<React.ClassAttributes<_WidgetRenderer> & LayoutItemProps & WidgetProps, "rotate" | "supportInlineEditing" | "supportRepeat" | "hasEmbeddedLayout" | "canCrossLayoutBoundary" | "widgetId" | "widgetJson" | "isClassLoaded" | "isInlineEditing" | "onInitResizeHandler" | "isFunctionalWidget" | "widgetState" | "widgetStyle" | "hasExtension"> & LayoutItemProps>;
export {};
