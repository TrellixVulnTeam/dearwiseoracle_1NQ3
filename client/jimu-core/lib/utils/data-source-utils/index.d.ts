...
export declare function getOriginDataLabel(serviceDefinition: ServiceDefinition, layer: __esri.Layer | __esri.Sublayer, ds: DataSource): Promise<string>;
/**
...
export declare function supportTime(dataSource: FeatureLayerDataSource): boolean;
